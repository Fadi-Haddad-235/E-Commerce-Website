window.onload = function() {
    ...
    axios.get(`http://localhost/E-Commerce-Website-backend/category.php?category=${category}`)
    .then(response => {
        ...
        items.forEach(item => {
            const html = `
              <div class="box">
                <div class="image">
                  <a href="http://localhost/E-Commerce-Website-backend/productdetails.php?name=${item.name}"><img src="${item.src}" alt=""></a>
                </div>
                <div class="info">
